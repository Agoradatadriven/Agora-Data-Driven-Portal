...
rem  under agora-platform\dash\ and refresh to see changes -- no deploy, no push.
...
echo.
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0agora-platform\dash\run_local.ps1"
echo.
