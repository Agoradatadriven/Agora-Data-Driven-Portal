# Windsor ingest (`ingest/windsor_data_pull/`)
...
Each connector `x` lives in `ingest/windsor_data_pull/x/` and contains:
...
[`scripts/deploy_ingest_jobs.ps1`](../../scripts/deploy_ingest_jobs.ps1). Its `$JOBS`
