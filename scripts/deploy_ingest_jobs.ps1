...
# the ingest/windsor_data_pull/<x> directories must match it exactly. Connector
...
#     windsor-ga4         ingest/windsor_data_pull/ga4         windsor-ga4-ingest         1Gi   1  10 1 * * *
#     windsor-google-ads  ingest/windsor_data_pull/google_ads  windsor-google-ads-ingest  1Gi   1  15 1 * * *
#     windsor-meta        ingest/windsor_data_pull/meta        windsor-meta-ingest        1Gi   1  20 1 * * *
#     (commented-out, not built yet:)
#     windsor-tradedesk   ingest/windsor_data_pull/tradedesk   windsor-tradedesk-ingest   1Gi   1  25 1 * * *
#     windsor-reddit      ingest/windsor_data_pull/reddit      windsor-reddit-ingest      512Mi 1  30 1 * * *
#     windsor-hubspot     ingest/windsor_data_pull/hubspot     windsor-hubspot-ingest     512Mi 1  35 1 * * *
#     windsor-fields      ingest/windsor_data_pull/fields      windsor-fields-ingest      512Mi 1  40 1 * * *
#
# USAGE
#   .\scripts\deploy_ingest_jobs.ps1                 # build+deploy+schedule all jobs
#   .\scripts\deploy_ingest_jobs.ps1 -Only windsor-meta
#   .\scripts\deploy_ingest_jobs.ps1 -SkipBuild      # reuse current image, redeploy+reschedule
...
$JOBS = @(
  ...
  @{ key="windsor-ga4";        dir="ingest/windsor_data_pull/ga4";        job="windsor-ga4-ingest";        mem="1Gi";   cpu="1"; cron="10 1 * * *" }
  @{ key="windsor-google-ads"; dir="ingest/windsor_data_pull/google_ads"; job="windsor-google-ads-ingest"; mem="1Gi";   cpu="1"; cron="15 1 * * *" }
  @{ key="windsor-meta";       dir="ingest/windsor_data_pull/meta";       job="windsor-meta-ingest";       mem="1Gi";   cpu="1"; cron="20 1 * * *" }
  ...
  # @{ key="windsor-tradedesk"; dir="ingest/windsor_data_pull/tradedesk"; job="windsor-tradedesk-ingest"; mem="1Gi";   cpu="1"; cron="25 1 * * *" }
  # @{ key="windsor-reddit";    dir="ingest/windsor_data_pull/reddit";    job="windsor-reddit-ingest";    mem="512Mi"; cpu="1"; cron="30 1 * * *" }
  # @{ key="windsor-hubspot";   dir="ingest/windsor_data_pull/hubspot";   job="windsor-hubspot-ingest";   mem="512Mi"; cpu="1"; cron="35 1 * * *" }
  # @{ key="windsor-fields";    dir="ingest/windsor_data_pull/fields";    job="windsor-fields-ingest";    mem="512Mi"; cpu="1"; cron="40 1 * * *" }
)
...
# Anchor build-context paths to the repo root (parent of scripts/) so this script works
