...
# separately (additively) by scripts\enable_platform_sso.ps1 AFTER this service is
...
$VALIDATOR = Join-Path $REPO_ROOT "scripts\_validate_dash_js.py"
...
Write-Host "     Next: map template.agoradatadriven.com, then run scripts\enable_platform_sso.ps1 -Keys template"
