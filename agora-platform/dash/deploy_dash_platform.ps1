...
# (agora-platform\deploy_platform.ps1) has already created the SA, bucket, secrets,
...
# (they are created by deploy_platform.ps1).
#
...
# Secrets mounted as env vars (Secret Manager, :latest). Created by deploy_platform.ps1.
