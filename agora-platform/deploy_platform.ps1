# =============================================================================
# deploy_platform.ps1 -- ONE-SHOT, IDEMPOTENT standup of the portal/CRM front-door
...
# scripts\enable_platform_sso.ps1. Granting the portal god-mode (super-admin console)
# is likewise separate -- scripts\enable_super_admin.ps1. Keep those out of this
...
#   .\agora-platform\deploy_platform.ps1 -SkipBuild # reuse current image, redeploy only
#   .\agora-platform\deploy_platform.ps1 -SkipSeed  # skip the registry seed step
# =============================================================================
...
if (-not $SkipSeed) {
    ...
    if (-not (Test-Path $VENV_PY)) { Die "repo .venv python not found at $VENV_PY (run scripts\setup.ps1 first)" }
...
Write-Host "       - .\scripts\enable_super_admin.ps1                      # super-admin console"
Write-Host "       - .\scripts\enable_platform_sso.ps1 -Keys ""template""  # trust portal SSO on dashboards"
